...
<body>
  ...
  <div id="container">
    ...
    <object id="font_getter" name="font_getter" type="application/x-shockwave-flash" data="fla/font_getter_1.swf" width="1" height="1">
    <param name="movie" value="fla/font_getter_1.swf" />
</object>
	...
	<option value="197">26</option>
		...
		for ($i = 100; $i <= 950; $i += 10) {
		    print '<option value="'.$i.'">'.$i.'px</option>';
		}
